...
[gf_bin_herm_elec, gf_wei_herm_elec] = global_features_extraction(cook_herm_elec,1);
[gf_bin_herm_comb, gf_wei_herm_comb] = global_features_extraction(cook_herm_combined,1);

[gf_bin_male_chem, gf_wei_male_chem] = global_features_extraction(cook_male_chem,1);
[gf_bin_male_elec, gf_wei_male_elec] = global_features_extraction(cook_male_elec,1);
[gf_bin_male_comb, gf_wei_male_comb] = global_features_extraction(cook_male_combined,1);
...
writetable(gf_wei_herm_comb, fullfile(result_path,'cook_herm_combined_weighted_global_features.csv'));
%male binary
...
writetable(gf_wei_male_comb, fullfile(result_path,'cook_male_combined_weighted_global_features.csv'));
%witv7 binary
