...
cook_herm_chem_witneurons_deg = cook_herm_chem_witneurons_lf.degree;
cook_herm_chem_witneurons_deg_ccdf = 1 - ecdf(cook_herm_chem_witneurons_deg); %cumulative distribution
cook_herm_chem_witneurons_deg_unq = [0; unique(cook_herm_chem_witneurons_deg)]; %added 0 to balance size

cook_male_chem_witneurons_deg = cook_male_chem_witneurons_lf.degree;
cook_male_chem_witneurons_deg_ccdf = 1 - ecdf(cook_male_chem_witneurons_deg); %cumulative distribution
cook_male_chem_witneurons_deg_unq = [0; unique(cook_male_chem_witneurons_deg)]; %added 0 to balance size
...
[cook_herm_chem_witneurons_deg_logn_ccdf, cook_herm_chem_witneurons_deg_logn_ksh, cook_herm_chem_witneurons_deg_logn_ksp,...
    cook_herm_chem_witneurons_deg_logn_ff, cook_herm_chem_witneurons_deg_logn_fp] = fit_distribution(cook_herm_chem_witneurons_deg, 'logn');


[cook_male_chem_witneurons_deg_logn_ccdf, cook_male_chem_witneurons_deg_logn_ksh, cook_male_chem_witneurons_deg_logn_ksp,...
    cook_male_chem_witneurons_deg_logn_ff, cook_male_chem_witneurons_deg_logn_fp] = fit_distribution(cook_male_chem_witneurons_deg, 'logn');
...
[cook_herm_chem_witneurons_deg_wbl_ccdf, cook_herm_chem_witneurons_deg_wbl_ksh, cook_herm_chem_witneurons_deg_wbl_ksp,...
    cook_herm_chem_witneurons_deg_wbl_ff, cook_herm_chem_witneurons_deg_wbl_fp] = fit_distribution(cook_herm_chem_witneurons_deg, 'wbl');

[cook_male_chem_witneurons_deg_wbl_ccdf, cook_male_chem_witneurons_deg_wbl_ksh, cook_male_chem_witneurons_deg_wbl_ksp,...
    cook_male_chem_witneurons_deg_wbl_ff, cook_male_chem_witneurons_deg_wbl_fp] = fit_distribution(cook_male_chem_witneurons_deg, 'wbl');
...
fprintf('Herm Chem wit neurons:\n');
fprintf('Lognormal: %.4f \t Weibull:%.4f \t \n',...
    cook_herm_chem_witneurons_deg_logn_ksp,cook_herm_chem_witneurons_deg_wbl_ksp);

fprintf('Male Chem wit neurons:\n');
fprintf('Lognormal: %.4f \t Weibull:%.4f \t \n',...
    cook_male_chem_witneurons_deg_logn_ksp,cook_male_chem_witneurons_deg_wbl_ksp);
...
marker_edge_width = 2;
line_width = 2;
loglog(cook_herm_chem_witneurons_deg_unq,cook_herm_chem_witneurons_deg_ccdf,'go', 'MarkerSize',marker_size);
hold on;
loglog(cook_herm_chem_witneurons_deg_logn_ff, cook_herm_chem_witneurons_deg_logn_ccdf,'g','LineWidth', line_width);

loglog(cook_male_chem_witneurons_deg_unq,cook_male_chem_witneurons_deg_ccdf,'ro','MarkerSize',marker_size);
hold on;
loglog(cook_male_chem_witneurons_deg_logn_ff, cook_male_chem_witneurons_deg_wbl_ccdf,'r','LineWidth',line_width);
...
%exporting publication-quality figures is performed using the package
%export_dig: https://github.com/altmany/export_fig 
fig_save_path = fullfile(fileparts(pwd), "figure_components", "deg_dist_cook_wit_restricted.pdf");
export_fig(fig_save_path);