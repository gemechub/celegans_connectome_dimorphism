...
cook_witv_witneurons_lf_overlap = readtable(fullfile(results_path, 'cook_wit_witneurons_overlapping_neurons_local_features.csv'));
...
deg_outlier_cook_wit7_witneurons = dimorphic_neurons(cook_witv_witneurons_lf_overlap, 'degree_cook', 'degree_wit7');
deg_outlier_cook_wit8_witneurons = dimorphic_neurons(cook_witv_witneurons_lf_overlap, 'degree_cook', 'degree_wit8');
...
stren_outlier_cook_wit7_witneurons = dimorphic_neurons(cook_witv_witneurons_lf_overlap, 'strength_cook', 'strength_wit7');
stren_outlier_cook_wit8_witneurons = dimorphic_neurons(cook_witv_witneurons_lf_overlap, 'strength_cook', 'strength_wit8');
...
cc_outlier_cook_wit7_witneurons = dimorphic_neurons(cook_witv_witneurons_lf_overlap, 'CC_bin_cook', 'CC_bin_wit7');
cc_outlier_cook_wit8_witneurons = dimorphic_neurons(cook_witv_witneurons_lf_overlap, 'CC_bin_cook', 'CC_bin_wit8');
...
bc_outlier_cook_wit7_witneurons = dimorphic_neurons(cook_witv_witneurons_lf_overlap, 'BC_bin_norm_cook', 'BC_bin_norm_wit7');
bc_outlier_cook_wit8_witneurons = dimorphic_neurons(cook_witv_witneurons_lf_overlap, 'BC_bin_norm_cook', 'BC_bin_norm_wit8');
